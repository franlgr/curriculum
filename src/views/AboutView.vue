              ...
              <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                ...
                <div class="md:flex font-bold text-gray-800">
                  <div class="w-full md:w-33 flex space-x-3">
                    <div class="md:w-full hover:bg-green-200 shadow-lg py-1 shadow-teal-500/50 rounded">
                    ...
                    <div class="w-full hover:bg-green-200 rounded py-2 shadow-lg shadow-teal-500/50">
                  ...
                  <div class="w-33 md:w-1/2 flex space-x-3">
                    <div class="w-full hover:bg-green-200 rounded py-2 shadow-lg shadow-teal-500/50">
                      <div class="flex justify-center items-center">
