...
export default {
  ...
  //       return false;
  //     }
  //     if (e.crlKey && e.shiftKey && e.keyCode == 'J'.charCodeAt(0)) {
  //       return false;
  //     }
